...
HVM_DIR="/mnt/data2/wuqingman/datasets/OmniSVG/MMSVG-Illustration/hvm_precomputed_1w"
VAL_DATA_DIR="/mnt/data2/wuqingman/datasets/OmniSVG/MMSVG-Illustration/data_val"
VAL_HVM_DIR="/mnt/data2/wuqingman/datasets/OmniSVG/MMSVG-Illustration/hvm_val"
...
if [ -n "$BASE_MODEL" ]; then
    TRAIN_ARGS+=(--base_model "$BASE_MODEL")
fi
