#!/bin/bash
# =============================================================================
# HVM-SVG 训练脚本 (A100_3 / CDM-only ablation)
# =============================================================================
#
# 用法:
#   CUDA_VISIBLE_DEVICES=0,1 bash run_train_hvm_a100_3.sh --num_gpus 2
#
# 消融实验: CDM-Only (no GME gist injection, no EDR routing)
#   gme_cdm mode + edr_disable_gist → 仅 detail cross-attn 注入
#   对比 s7 主实验 (gme_cdm_edr, gist+detail+routing)
#   验证 detail memory encoder 单独的贡献
...
# -- 日志与保存 --
OUTPUT_DIR="/mnt/data3/wuqingman/omnisvg-train/outputs_s8_cdm_only_top3part_12slot_parttag_nozoom"
LOG_EVERY=10
SAVE_EVERY=2000
EVAL_EVERY=500
SWANLAB_MODE="cloud"
SWANLAB_RUN_NAME="s8_cdm_only_top3part_12slot_parttag_nozoom"
