...
def create_collate_fn(
    ...
    def collate_fn(batch):
        text_oris, pil_images, pix_seq_lists, original_svgs = zip(*batch)
        ...
        return batch_messages, list(pix_seq_lists), batch_task_types, list(original_svgs)
...
def train(args, config: OmniSVGConfig):
    ...
    for epoch in range(starting_epoch, config.training.epochs):
        ...
        for batch_messages, pix_seq_lists, batch_task_types, original_svgs in train_dataloader:
