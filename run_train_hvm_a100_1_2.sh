...
# -- 日志与保存 --
OUTPUT_DIR="/mnt/data3/wuqingman/omnisvg-train/outputs_s10_onlylastlayer_top3part_12slot_nogist_edr_parttag_nozoom"
LOG_EVERY=10
SAVE_EVERY=2000
SWANLAB_MODE="cloud"
SWANLAB_RUN_NAME="s10_onlylastlayer_top3part_12slot_nogist_edr_parttag_nozoom"
...
if [ "$MEMORY_MODE" = "dense_global_local" ]; then
    echo "  Dense baseline:    raw global refs + raw local parts"
    echo "  Local disable tag: ${CDM_DISABLE_TAG_META}"
    echo "  Local disable gid: ${CDM_DISABLE_GROUP_ID}"
fi
